...
export default function RootLayout() {
  ...
  // Hide splash once fonts are ready (or errored). Also set a 3-second hard
  // failsafe using SplashScreen.hide() from expo-router (calls the internal
  // hide which clears expo-router's own prevent counter).
  useEffect(() => {
