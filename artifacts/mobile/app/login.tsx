      ...
      >
          ...
          <View style={styles.field}>
            ...
            <TextInput
              ...
              style={[
                styles.input,
                {
                  borderColor: error && !username.trim() ? colors.destructive : colors.border,
        ...
        <View style={styles.socialButtons}>
          ...
          <Pressable
            ...
            style={({ pressed }) => [
              styles.socialBtn,
              { backgroundColor: "#1877F2", borderColor: "#1877F2", opacity: pressed ? 0.8 : 1 },
            ]}
          >
            <Text style={styles.fbF}>f</Text>
            <Text style={[styles.socialBtnText, { color: "#fff" }]}>
              Nastavi s Facebook računom
            </Text>
          </Pressable>
        </View>
