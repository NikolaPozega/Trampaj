...
- [hermesc broken on EAS](hermesc-jsc-fix.md) — 0.12.0 placeholder no async arrow support; DO NOT use jsEngine:jsc (breaks worklets); fix: EAS post-install hook builds hermesc from source.
