...
- [OTA update from Replit](ota-update-replit.md) — hermesc linux64 broken; use expo export --no-bytecode + eas update --skip-bundler --input-dir + EAS_SKIP_AUTO_FINGERPRINT=1; latest: dist8.
